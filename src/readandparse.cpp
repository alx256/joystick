...
std::string JoyfileParser::getError()                   { return error; }
std::string JoyfileParser::getPath()                    { return path; }

bool JoystickTotemLibrary::isFunction(std::string instruction)          { return functions.find(instruction) != functions.end(); }
bool JoystickTotemLibrary::isProjectFunction(std::string instruction)   { return projectFunctions.find(instruction) != projectFunctions.end(); }
